<?php
    ...
    $query = "SELECT distinct app, category, installs, rating, price, reviews, size, `type`,`content rating`, genres, `Last Updated`, `current ver`, `android ver` FROM googleplaystore WHERE app='{$filtered_id}'";
...
<body>
    <h1 style="display:inline"><?=ucfirst($filtered_id)?> | </h1> 
